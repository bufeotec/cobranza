...
//error: Error
//warning: Advertencia
function respuesta(mensaje, tipo, tiempo = 3000, esHtml = false) {
    ...
    Toast.fire({
        icon: tipo,
        title: esHtml ? undefined : mensaje, // solo texto
        html: esHtml ? mensaje : undefined   // permite HTML si lo activamos
    });
}
