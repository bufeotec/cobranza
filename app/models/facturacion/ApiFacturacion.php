 ...
 * Time: 10:10 a. m.
 */
require 'app/models/facturacion/Signature.php';
require_once ("app/models/facturacion/Ventas.php");


class ApiFacturacion
{
    public function EnviarComprobanteElectronico($emisor, $nombre, $rutacertificado, $ruta_archivo_xml, $ruta_archivo_cdr,$id_venta): int
    {
        ...
        if(_MODE_ == 'test'){
            ...
            $ruta_firma = $rutacertificado. 'certificado_20162270134.pfx';
            $pass_firma = 'wyLBVyXVFizX4b3';
        }
        ...
        if($result == 1){
            ...
            if($httpcode == 200){
                ...
                if (isset($doc->getElementsByTagName('ticket')->item(0)->nodeValue)) {
                    ...
                    $codigo = $doc->getElementsByTagName("faultcode")->item(0)->nodeValue;
                    $mensaje = $doc->getElementsByTagName("faultstring")->item(0)->nodeValue;
                    //Inicio - Modificacion para envio de Boletas Multisucursal
                    if($codigo == "soap-env:Client.2223"){
                    ...
                    //Fin - Modificacion para envio de Boletas Multisucursal
                }
    ...
    function ConsultarTicket($emisor, $cabecera, $ticket, $ruta_archivo_cdr, $tipo)
    {
        ...
        if(_MODE_ == "test"){
            $ruta_firma = 'certificado_prueba.pfx'; //ruta del archivo del certicado para firmar
            $pass_firma = '12345678'; //contraseña del certificado
        } else {
            $ruta_firma = 'certificado_20162270134.pfx';
            $pass_firma = 'wyLBVyXVFizX4b3';
        }
