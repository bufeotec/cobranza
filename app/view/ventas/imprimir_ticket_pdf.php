...
$pdf->Cell(60,4, "EFA IMPORT E.I.R.L",0,1,'C',0);
//$pdf->Cell(60,4, "DESARROLLO HUMANO",0,1,'C',0);
$pdf->Cell(60,4,"RUC Nº $dato_venta->empresa_ruc",0,1,'C');
$pdf->SetFont('Helvetica','',7);
//$pdf->Cell(60,4,"$dato_pago->empresa_domiciliofiscal",0,1,'C');
$pdf->Cell(60,4,"JR. CONDAMINE N° 589",0,1,'C');
$pdf->Cell(60,4,"LORETO - MAYNAS - IQUITOS",0,1,'C');
//$pdf->Cell(60,4,"Tel. $dato_venta->empresa_celular1",0,1,'C');
//$pdf->Cell(60,4,"E-mail: $dato_venta->empresa_correo",0,1,'C');
$pdf->Cell(60,4,"Ventas de Accesorios y ropa deportiva al por",0,1,'C');
$pdf->Cell(60,4,"menor y mayor precio.",0,1,'C');
...
$pdf->MultiCell(60,4,"Forma Pago: " .$detalle_cuotas,0,1,'');
$pdf->Cell(60,4,"$dato_impresion",1,1,'C');

// COLUMNAS
$pdf->SetFont('Helvetica','B',7);
$pdf->Cell(40, 10, 'Descripción', 0,'','L');
//$pdf->Cell(5, 10, 'Cant',0,0,'R');
$pdf->Cell(8, 10, 'Precio',0,0,'R');
$pdf->Cell(12, 10, 'Total',0,0,'R');
$pdf->Ln(8);
$pdf->Cell(60,0,'','T');
$pdf->Ln(1);
...
foreach ($detalle_venta as $f){
    $pdf->SetFont('Helvetica', '', 7);
    $pdf->CellFitSpace(40,4,"[1].$f->venta_detalle_descripcion",0,'');
    //$pdf->Cell(35, -5, "$f->venta_detalle_cantidad",0,0,'R');
    $pdf->Cell(8, '5', number_format(round("$f->venta_detalle_valor_total",2), 2, ',', ' '),0,0,'R');
    $pdf->Cell(12, '5', number_format(round("$f->venta_detalle_valor_total",2), 2, ',', ' '),0,0,'R');
    $pdf->Ln(2);
}
...
if($dato_venta->venta_totaldescuento > 0){
    $pdf->Cell(60, 1.5, "Descuento: $dato_venta->simbolo $dato_venta->venta_totaldescuento", 0,'1','R');
}
$pdf->Ln();
...
$pdf->Ln();
$pdf->SetFont('', '', '6');
if($dato_venta->venta_pago_cliente > 0){
...
$pdf->Cell(60,0,'---------------------------------------------------',0,1,'C');
$pdf->Ln(3);
$pdf->Cell(60,0,'Bufeo Tec Company',0,1,'C');
$pdf->Ln(3);
$pdf->Cell(60,0,'Digitalízate',0,1,'C');
$pdf->Ln(3);
